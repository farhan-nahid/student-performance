...
async function main() {
  try {
    ...
    console.log(`P(low stress | pass) = ${(await computeLowStressGivenPass()).toFixed(4)}`);
    console.log(`P(tutoring | fail) = ${(await computeTutoringGivenFail()).toFixed(4)}`);
    console.log(`P(no tutoring | pass) = ${(await computeNoTutoringGivenPass()).toFixed(4)}`);
    console.log(`P(high income | pass) = ${(await computeHighIncomeGivenPass()).toFixed(4)}`);
    console.log(`P(low income | fail) = ${(await computeLowIncomeGivenFail()).toFixed(4)}`);
    console.log(`P(extracurricular | fail) = ${(await computeExtracurricularGivenFail()).toFixed(4)}`);
    console.log(`P(no extracurricular | pass) = ${(await computeNoExtracurricularGivenPass()).toFixed(4)}`);
    console.log(`P(internet access | fail) = ${(await computeInternetAccessGivenFail()).toFixed(4)}`);
    console.log(`P(no internet access | pass) = ${(await computeNoInternetAccessGivenPass()).toFixed(4)}`);
    console.log(`P(previous grade = A | pass) = ${(await computePreviousGradeAGivenPass()).toFixed(4)}`);
    console.log(`P(previous grade = F | fail) = ${(await computePreviousGradeFGivenFail()).toFixed(4)}`);
    console.log(`P(visual learning | pass) = ${(await computeVisualLearningGivenPass()).toFixed(4)}`);
    console.log(`P(kinesthetic learning | fail) = ${(await computeKinestheticLearningGivenFail()).toFixed(4)}`);
    console.log(`P(public school | pass) = ${(await computePublicSchoolGivenPass()).toFixed(4)}`);
    console.log(`P(private school | fail) = ${(await computePrivateSchoolGivenFail()).toFixed(4)}`);
    console.log(`P(high teacher quality | pass) = ${(await computeHighTeacherQualityGivenPass()).toFixed(4)}`);
    console.log(`P(low teacher quality | fail) = ${(await computeLowTeacherQualityGivenFail()).toFixed(4)}`);
    console.log(`P(high attendance | pass) = ${(await computeHighAttendanceGivenPass()).toFixed(4)}`);
